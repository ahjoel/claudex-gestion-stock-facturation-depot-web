...
import AddFactureDrawer from 'src/gestion-bars/views/rc/facturesrc/AddFactureDrawer'
import { CircularProgress } from '@mui/material'
import FactureDetail from 'src/gestion-bars/logic/models/FactureDetail'
import TableHeaderDetail from 'src/gestion-bars/views/rc/facturesrc/TableHeaderDetail'
...
import AddFactureDetailDrawer from 'src/gestion-bars/views/rc/facturesrc/AddFactureDetailDrawer'
import SortieRCService from 'src/gestion-bars/logic/services/SortieRCService'
...
const FactureList = () => {
  ...
  const mouvementService = new SortieRCService()
  ...
  const getListFactures = async (page: number, pageSize: number) => {
    const result = await factureService.listFacturesRC({ page: page + 1, length: pageSize })
  ...
  const getDetailsFacture = async () => {
    ...
    const result = await factureService.listFactureDetailRC({ code: code || null })
