...
const ProduitList = () => {
  ...
  return (
    <Grid container spacing={6.5}>
      <Grid item xs={12}>
        <Card>
          <TableHeader value={value} handleFilter={handleFilter} toggle={handleCreateProduit} />
      ...
      <AddProduitDrawer open={addProduitOpen} toggle={toggleAddProduitDrawer} onChange={handleChange} currentProduit={currentProduit} onSuccess={handleSuccess} models={models} modelId={modelId} fournisseurs={fournisseurs} fournisseurId={fournisseurId} />
