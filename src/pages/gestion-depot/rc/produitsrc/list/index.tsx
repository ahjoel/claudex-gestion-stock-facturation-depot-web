...
import TableHeader from 'src/gestion-depot/views/rc/produitsrc/list/TableHeader'
import AddProduitDrawer from 'src/gestion-depot/views/rc/produitsrc/list/AddProduitDrawer'
