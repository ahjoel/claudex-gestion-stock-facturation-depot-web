...
import TableHeader from 'src/gestion-depot/views/entreer1/list/TableHeader'
import AddEntreeR1Drawer from 'src/gestion-depot/views/entreer1/list/AddEntreeR1Drawer'
...
import EntreeR1 from 'src/gestion-depot/logic/models/EntreeR1'
