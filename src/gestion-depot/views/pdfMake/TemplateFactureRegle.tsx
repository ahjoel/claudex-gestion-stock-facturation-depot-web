...
const TemplateFactureRegle: React.FC<PdfDocumentProps> = ({ data, fileName, client, code, remise, dateFact, auteur, mtrestant, mtencaisse, impayee, dateEcheance }) => {
  ...
  const generatePdf = () => {
    ...
    const paymentSummary = [
      [
        { text: 'Mode Paiement: ESPECES', style: 'paymentSummary', margin: [0, 5] },
        { text: `Ancien reste à payer: ${impayee}`, style: 'paymentSummary', margin: [0, 5] }
      ],
      [
        { text: `Date Echeance: ${dateEcheance}`, style: 'paymentSummary', margin: [0, 5] },
        { text: 'Reliquat: 0', style: 'paymentSummary', margin: [0, 5] }
      ],
      [
        { text: `Reste à payer: ${mtrestant}`, style: 'paymentSummary', margin: [0, 5] },
        { text: `Total Encaisse: ${mtencaisse}`, style: 'paymentSummary', margin: [0, 5] }
      ]
    ];
...
export default TemplateFactureRegle